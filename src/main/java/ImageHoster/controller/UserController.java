...
public class UserController {
    ...
    public String registerUser(User user, Model model) {
        ...
        boolean specialCharFound = Pattern.compile("[^A-Za-z0-9]").matcher(user.getPassword()).find();
        boolean atleastOneAlpha = Pattern.compile("[A-Za-z]").matcher(user.getPassword()).find();
        boolean atleastOneNum = Pattern.compile("[0-9]").matcher(user.getPassword()).find();
        if (specialCharFound && atleastOneAlpha && atleastOneNum) {
